...
const descVFO = ["A website that lets you login through your youtube account and customize the content you see from whoever you follow, (created this app because youtube recommendation algorithm is awful)",
...
const descNode = [  "A website (still in development) that allows the user to search for words & phases from a set of videos I have selected.",
                    'Server runs NodeJS, deployed in AWS Elastic Beanstalk, utilizing a few AWS services and a MongoDB Atlas cluster',
...
const descResume =["This résumé is not a template off the internet. I coded it.",
                    "Made with NodeJS, EJS, and SASS / CSS", 
